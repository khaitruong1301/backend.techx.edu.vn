...
namespace CinimaServer.Tools
{
    ...
    {
       public static string secretKey = "KHAI_TECHX_KHAI_TECHX_KHAI_TECHX_KHAI_TECHX_KHAI_TECHX_KHAI_TECHX_KHAI_TECHX";
        public static string issuer = "14120";
        public static string audience = "KAITOKIDO";
    }
